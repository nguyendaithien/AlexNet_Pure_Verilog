...
*                         Figure 1: Work flow for software-hardware co-design.*
...
- Range of weight values across hidden layers: From left to right, the histograms represent the distribution of weights for the following layers in order:
CONV1, CONV2, CONV3, CONV4, CONV5, and FC1, FC2, FC3.
